        ...
        <div class="card">
         ...
         <div class="card-body">
          <table class="table table-responsive-sm table-striped">
           ...
           <tbody>
           <%
           ArrayList<Rate> rate_list = (ArrayList<Rate>) request.getAttribute("rate_list");
           for (int i = 0; i < rate_list.size(); i++){
           %>
            <tr>
             <td><%= rate_list.get(i).getUsernameString() %></td>
             <td><%= rate_list.get(i).getRateFloat() %></td>
             <td><%= rate_list.get(i).getDescriptionString() %></td>
            </tr>
            <% 
            	}
            %>

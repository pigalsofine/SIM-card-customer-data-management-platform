        ...
        <div class="card">
         ...
         <div class="card-body">
          <table class="table table-responsive-sm table-striped">
           ...
           <tbody>
           <%
           		ArrayList<Tag> tag_list = (ArrayList<Tag>) request.getAttribute("tag_list");
           		for (int i = 0; i < tag_list.size(); i++){
           %>
            <tr>
             <td><%= tag_list.get(i).getNameString() %></td>
             <td><%= tag_list.get(i).getTypeInteger() %></td>
             <td><%= tag_list.get(i).getPermissionInteger() %></td>
            </tr>
            <% 
            	}
            %>
